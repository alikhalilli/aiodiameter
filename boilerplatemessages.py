...
def makeDWR(appId, o_host='192.0.2.11', o_realm='example.com'):
...
def makeDWA(appId, o_host='192.0.2.11', o_realm='example.com'):
...
def makeCER(appId, o_host='192.0.2.11', o_realm='example.com'):
